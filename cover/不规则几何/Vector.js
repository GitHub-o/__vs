const Vector = (function () {
	...
	function Vector (container, anitOut) {
		if (!!document.createElement("canvas").getContext) {
			...
			var G = {
				...
				step: CAV.Vector3.create(Math.randomInRange(0.2, 1), Math.randomInRange(0.2, 1), Math.randomInRange(0.2,
					1))
			};
			var m = "canvas";
			var E = "svg";
